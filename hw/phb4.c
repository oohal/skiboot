...
static int64_t phb4_fake_scom_write(struct fake_scom *f, uint32_t chipid, uint64_t pcbaddr, uint64_t val)
{
	(void) val;
	(void) chipid;
	(void) pcbaddr;
...
static int64_t phb4_fake_scom_read(struct fake_scom *f, uint32_t chipid, uint64_t pcbaddr, uint64_t *val)
{
