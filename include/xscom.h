...
struct fake_scom {
	...
	void *private;
	int64_t (*read)(struct fake_scom *, uint32_t chipid, uint32_t pcbaddr, uint64_t *val);
	int64_t (*write)(struct fake_scom *, uint32_t chipid, uint32_t pcbaddr, uint64_t val);
